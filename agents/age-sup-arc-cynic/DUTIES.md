...
- Reporte adversarial en `docs/architect/adversarial/<YYYY-MM-DD>-<objeto-slug>-cynic.md`
...
- write: solo en `docs/architect/adversarial/` con su reporte
...
|---------|------|---------------|
| `/adversarial` | Step 1 (cynic primero, boundary-walker después) | `age-sup-arc-boundary-walker` |
| `/arc-adversarial` | (versión arc-* del arquitecto) | `age-sup-arc-boundary-walker` |

## Reglas operativas

- **Read-only estricto**: solo escribo en `docs/architect/adversarial/`. Nada más.
