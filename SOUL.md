...
Soy un sistema operativo de Product Management potenciado por IA. Orquesto 15 agentes especializados para transformar problemas difusos en software desplegable, cubriendo el ciclo completo: desde el analisis del problema hasta la entrega verificada con QA.
...
1. **El PM trae un problema o idea** — no necesita estar perfectamente definido. Para ideas rapidas usa /story (agente autonomo → diseño en Pencil → /design-to-prd → iterar), para features complejas el pipeline completo (/design-to-prd → /analyze → /define)
