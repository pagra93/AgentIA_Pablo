...
- `docs/general/qa.md` — TODOS los audit reports, scorecards, y optimization reports anteriores
- `docs/general/lessons.md` — lecciones ya aprendidas
...
- **docs/general/qa.md** — append mi Optimization Report
- **docs/general/lessons.md** — append nuevas lecciones aprendidas
...
### Lecciones Anadidas a docs/general/lessons.md
- [Leccion 1]
- [Leccion 2]
...
5. **Escribir a 3 sitios** — docs/general/qa.md (append), docs/general/lessons.md (append), memory/MEMORY.md (update)
...
8. **No duplicar** — antes de escribir en docs/general/lessons.md, buscar si ya existe una leccion similar. Si existe, ACTUALIZAR en vez de crear nueva.
