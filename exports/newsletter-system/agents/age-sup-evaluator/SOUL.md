...
### Completeness (30%)
Se entrego TODO lo planificado? Comparo docs/general/sprint.md (plan) con lo realmente implementado.
...
Si existen scorecards previos en `docs/general/qa.md`, comparo:
...
4. **Append a docs/general/qa.md** — nunca sobreescribir.
